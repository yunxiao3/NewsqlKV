 ...
 * peer_host_info: Information about other machines in the distributed cluster. This value is nullptr in the preliminary
 * round. peer_host_info_num: The num of other machines in the distributed cluster.  This value is 0 in the preliminary
 * round. aep_dir: AEP file directory, eg : "/mnt/aep/" disk_dir: Disk file directory, eg : "/mnt/disk/"
 */
